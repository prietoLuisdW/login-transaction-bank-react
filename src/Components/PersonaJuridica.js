                    ...
                    <fieldset className="row">
                        <div className="row">
                            <div className="col p-0 pb-1">
                                <input tipe="number" id="tipoIdentificacion" className='form-control' placeholder='Ingrese su Grupo Empresarial'></input>
                            </div>
                        ...
                        <div className="row">
                            <div className="col p-0 pb-1">
                                <input type="password" id="token" className='form-control' placeholder="Ingrese su Token"></input>
                            </div>
                            <div className="col p-0">
                                <input type="pasword" id="pasword" className='form-control' placeholder='Ingrese su Clave Internet'></input>
                            </div>
                        </div>
